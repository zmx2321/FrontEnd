...
(function(Q, X, w) {
        ...
        for (var d = b.$$hashKey, e = 0, f = a.length; e < f; ++e) {
            ...
            if (B(g) || x(g))
                for (var h = Object.keys(g), l = 0, k = h.length; l < k; l++) {
                    var n = h[l]
                      , p = g[n];
                    c && B(p) ? da(p) ? b[n] = new Date(p.valueOf()) : Oa(p) ? b[n] = new RegExp(p) : (B(b[n]) || (b[n] = J(p) ? [] : {}),
                    Mb(b[n], [p], !0)) : b[n] = p
                }
        }
        oc(b, d);
    ...
    function xc(b) {
        ...
        m((b || "").split("&"), function(b) {
            ...
            e = wc(e),
            A(e) && (f = A(f) ? wc(f) : !0,
            ta.call(a, e) ? J(a[e]) ? a[e].push(f) : a[e] = [a[e], f] : a[e] = f))
        });
        return a
    }
    function Pb(b) {
    ...
    function yc(b, a, c) {
        ...
        Q && e.test(Q.name) && (c.debugInfoEnabled = !0,
        Q.name = Q.name.replace(e, ""));
        if (Q && !f.test(Q.name))
            return d();
    ...
    function ae() {
        ...
        if (!Ac) {
            var a = pb();
            (ra = v(a) ? Q.jQuery : a ? Q[a] : w) && ra.fn.on ? (C = ra,
            P(ra.fn, {
                scope: Ra.scope,
            ...
            m(a, function(a) {
                ...
                if (!n.get(a)) {
                    ...
                    try {
                        ...
                        d(c._invokeQueue),
                        d(c._configBlocks)) : x(a) ? b.push(r.invoke(a)) : J(a) ? b.push(r.invoke(a)) : Sa(a, "module")
                    } catch (e) {
        ...
        l.url = function(a, c, e) {
            ...
            if (a) {
                ...
                if (!d.history || h && f) {
                    ...
                    n[c ? "replaceState" : "pushState"](e, "", a),
                    g(),
                    q = u;
                return l
            }
    ...
    function Cc(b, a) {
            ...
            b.factory(a + "Directive", ["$injector", "$exceptionHandler", function(b, d) {
                ...
                m(e[a], function(e, h) {
                    try {
                        ...
                        B(l.scope) && (!0 === l.bindToController ? (n.bindToController = c(l.scope, r, !0),
        ...
        this.aHrefSanitizationWhitelist = function(b) {
            return A(b) ? (a.aHrefSanitizationWhitelist(b),
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function(a, b, c, d, u, q, z, N, ia, O, H) {
            ...
            function D(a, b, d, e, f, h, g, k, r) {
                ...
                function K(a, c, e, f, h, l) {
                    ...
                    u && (W.$$addScopeInfo(N, E, !0, !(L && (L === u || L === u.$$originalDirective))),
                    W.$$addScopeClass(N, !0),
                    E.$$isolateBindings = u.$$isolateBindings,
                    Y(c, f, E, E.$$isolateBindings, u, E));
                    if (ca) {
                        var Va = u || S, m;
                        Va && ca[Va.name] && (q = Va.$$bindings.bindToController,
                        (H = ca[Va.name]) && H.identifier && q && (m = H,
                        l.$$destroyBindings = Y(c, f, H.instance, q, Va)));
                        for (n in ca) {
                            H = ca[n];
                            var D = H();
                            D !== H.instance && (H.instance = D,
                            N.data("$" + n + "Controller", D),
                            H === m && (l.$$destroyBindings(),
                ...
                for (var H = -Number.MAX_VALUE, S = r.newScopeDirective, ba = r.controllerDirectives, u = r.newIsolateScopeDirective, L = r.templateDirective, z = r.nonTlbTranscludeDirective, N = !1, m = !1, ia = r.hasElementTranscludeDirective, v = d.$$element = C(b), D, y, M, Ka = e, na, I = 0, F = a.length; I < F; I++) {
                    ...
                    if (H > D.priority)
                        break;
                    if (M = D.scope)
                        D.templateUrl || (B(M) ? (Q("new/isolated scope", u || S, D, v),
                        u = D) : Q("new/isolated scope", u, D, v)),
                        S = S || D;
                    y = D.name;
                    !D.templateUrl && D.controller && (M = D.controller,
                    ba = ba || ha(),
                    Q("'" + y + "' controller", ba[y], D, v),
                    ba[y] = D);
                    if (M = D.transclude)
                        N = !0,
                        D.$$tlb || (Q("transclusion", z, D, v),
                        z = D),
                        "element" == M ? (ia = !0,
                        H = D.priority,
                        M = v,
                        v = d.$$element = C(X.createComment(" " + y + ": " + d[y] + " ")),
                        b = v[0],
                        U(f, ua.call(M, 0), b),
                        Ka = W(M, e, H, h && h.name, {
                    ...
                    D.terminal && (K.terminal = !0,
                    H = Math.max(H, D.priority))
                }
                K.scope = S && !0 === S.scope;
            ...
            function U(a, b, c) {
                ...
                a.appendChild(d);
                C.hasData(d) && (C(c).data(C(d).data()),
                ra ? (Qb = !0,
                ra.cleanData([d])) : delete C.cache[d[C.expando]]);
                d = 1;
                for (e = b.length; d < e; d++)
                    f = b[d],
                    C(f).remove(),
    ...
    function Ve() {
        ...
        this.$get = ["$injector", "$window", function(c, d) {
            ...
            return function(f, g, h, l) {
                ...
                if (h)
                    return h = (J(f) ? f[f.length - 1] : f).prototype,
    ...
    function af() {
        ...
        this.$get = ["$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", function(e, f, g, h, l, k) {
            ...
            function p(c, d) {
                ...
                L && (m = L.get(ba),
                A(m) ? m && x(m.then) ? m.then(p, p) : J(m) ? k(m[1], m[0], ja(m[2]), m[3]) : k(m, 200, {}, "OK") : L.put(ba, H));
                v(m) && ((m = ed(c.url) ? f()[c.xsrfCookieName || b.xsrfCookieName] : w) && (S[c.xsrfHeaderName || b.xsrfHeaderName] = m),
                e(c.method, ba, d, g, S, c.timeout, c.withCredentials, c.responseType));
                return H
            }
            function r(a, b) {
    ...
    function bc(b, a, c) {
        ...
        this.$$parseLinkUrl = function(d, e) {
            ...
            var f, g;
            A(f = sa(b, d)) ? (g = f,
            g = A(f = sa(c, f)) ? a + (sa("/", f) || f) : b + g) : A(f = sa(a, d)) ? g = a + f : a == d + "/" && (g = a);
            g && this.$$parse(g);
            return !!g
        }
    }
    ...
    function ef() {
        ...
        this.html5Mode = function(b) {
            return bb(b) ? (a.enabled = b,
            this) : B(b) ? (bb(b.enabled) && (a.enabled = b.enabled),
            ...
            c.$watch(function() {
                ...
                if (K || r)
                    ...
                    c.$evalAsync(function() {
                        ...
                        k.$$state = f) : (r && h(b, g, f === k.$$state ? null : k.$$state),
                        l(a, f)))
                    });
                k.$$replace = !1
            });
        ...
        this.$get = ["$filter", function(c) {
            ...
            return function(d, k, E) {
                ...
                case "string":
                    ...
                    var s = E ? a : b;
                    m = s[q];
                    m || (":" === d.charAt(0) && ":" === d.charAt(1) && (u = !0,
                    d = d.substring(2)),
                    E = E ? p : n,
                    m = new ec(E),
                    m = (new fc(m,c,E)).parse(d),
                    m.constant ? m.$$watchDelegate = h : u ? m.$$watchDelegate = m.literal ? g : f : m.inputs && (m.$$watchDelegate = e),
                    s[q] = m);
                    return l(m, k);
                case "function":
                    return l(d, k);
        ...
        P(g.prototype, {
            ...
            $$resolve: function(b) {
                ...
                try {
                    if (B(b) || x(b))
                        d = b && b.then;
                    x(d) ? (this.promise.$$state.status = -1,
        ...
        this.$get = ["$injector", "$exceptionHandler", "$parse", "$browser", function(f, g, h, l) {
            ...
            n.prototype = {
                ...
                $digest: function() {
                    ...
                    p("$digest");
                    l.$$checkUrlChange();
                    this === q && null !== e && (l.defer.cancel(e),
                    s());
                    d = null ;
                    do {
                        r = !1;
    ...
    function xd(b) {
        ...
        return function(c, e, f) {
            ...
            if (!da(c) || !isFinite(c.getTime()))
                return c;
            for (; e; )
                (k = eg.exec(e)) ? (h = db(h, k, 1),
                e = h.pop()) : (h.push(e),
                e = null );
            var n = c.getTimezoneOffset();
            f && (n = vc(f, c.getTimezoneOffset()),
            c = Ob(c, f, !0));
            m(h, function(a) {
                l = fg[a];
    ...
    function kb(b, a, c, d) {
        return function(e, f, g, h, l, k, n) {
            ...
            h.$parsers.push(function(b) {
                return h.$isEmpty(b) ? null : a.test(b) ? (b = c(b, m),
                t && (b = Ob(b, t)),
                b) : w
            });
    ...
    function Fd(b) {
        function a(a, b) {
            b && !f[a] ? (l.addClass(e, a),
            f[a] = !0) : !b && f[a] && (l.removeClass(e, a),
            f[a] = !1)
        }
        function c(b, c) {
            b = b ? "-" + zc(b, "-") : "";
        ...
        readString: function(a) {
            ...
            for (var d = "", e = a, f = !1; this.index < this.text.length; ) {
                ...
                if (f)
                    ...
                    this.index += 4,
                    d += String.fromCharCode(parseInt(f, 16))) : d += pg[g] || g,
                    f = !1;
                else if ("\\" === g)
                    f = !0;
                else {
    ...
    s.prototype = {
        ...
        primary: function() {
            ...
            this.consume(")")) : this.expect("[") ? a = this.arrayDeclaration() : this.expect("{") ? a = this.object() : this.constants.hasOwnProperty(this.peek().text) ? a = ga(this.constants[this.consume().text]) : this.peek().identifier ? a = this.identifier() : this.peek().constant ? a = this.constant() : this.throwError("not a primary expression", this.peek());
    ...
    qd.prototype = {
        ...
        recurse: function(a, c, d) {
            ...
            case s.MemberExpression:
                ...
                a.computed || (Xa(a.property.name, g.expression),
                f = a.property.name),
        ...
        tb[c] = function() {
            return {
                ...
                link: function(d, e, f) {
                    var g = a
                      , h = a;
                    "href" === a && "[object SVGAnimatedString]" === va.call(e.prop("href")) && (h = "xlinkHref",
                    f.$attr[h] = "xlink:href",
                    g = null );
                    f.$observe(c, function(c) {
                        c ? (f.$set(h, c),
                        Wa && g && e.prop(g, f[h])) : "href" === a && f.$set(h, null )
                    })
                }
            }
        }
            ...
            compile: function(e, f) {
                ...
                return function(e, f, m, r, t) {
                    ...
                    e.$watch(g, function(g) {
                        ...
                        e.$emit("$includeContentRequested", g)) : (z(),
                        r.template = null )
                    })
                }
            }
      ...
      , Ne = ["$compile", function(a) {
        return {
            ...
            link: function(c, d, e, f) {
                ...
                a(Lc(f.template, X).childNodes)(c, function(a) {
                    d.append(a)
                }, {
      ...
      , Me = function() {
        return {
            ...
            controller: ["$scope", "$attrs", function(a, c) {
                ...
                this.$options.updateOn = T(this.$options.updateOn.replace(wg, function() {
            ...
            link: function(c, h, l, k) {
                ...
                function v() {
                    ...
                    x.items.forEach(function(a) {
                        ...
                        k = p(g.groupElement, g.currentOptionElement, "option", e),
                        n(a, k),
                        g.currentOptionElement = k.nextSibling) : (k = p(h[0], d, "option", e),
                        n(a, k),
                        d = k.nextSibling)
                    });
                    ...
                    if (!w.$isEmpty(a)) {
                        var g = u.readValue();
                        (B.trackBy ? ka(a, g) : a === g) || (w.$setViewValue(g),
                        w.$render())
                    }
                }
                var w = k[1];
                if (w) {
                    ...
                    B.trackBy && c.$watchCollection(function() {
                        ...
                        c && !c.disabled ? h[0].value !== c.selectValue && (H.remove(),
                        O || q.remove(),
                        h[0].value = c.selectValue,
                        c.element.selected = !0,
                        c.element.setAttribute("selected", "selected")) : null === a || O ? (H.remove(),
                        O || h.prepend(q),
                        h.val(""),
                        q.prop("selected", !0),
                        q.attr("selected", !0)) : (O || q.remove(),
                        h.prepend(H),
                        h.val("?"),
                        H.prop("selected", !0),
                        H.attr("selected", !0))
                    ...
                    u.readValue = function() {
                        ...
                        return a && !a.disabled ? (O || q.remove(),
                        H.remove(),
                    ...
                    O ? (q.remove(),
                    a(q)(c),
                    q.removeClass("ng-scope")) : q = C(e.cloneNode(!1));
                    v();
        ...
        return {
            link: function(g, h, l) {
                ...
                g.$watch(n, function(c) {
                    ...
                    e === x || f && V(x) && isNaN(x) || (z(),
                    f = w[e],
                    v(f) ? (null != c && d.debug("ngPluralize: no rule defined for '" + e + "' in " + p),
                    z = y,
                    k()) : z = g.$watch(f, k),
                    x = e)
                })
                    ...
                    a.$watchCollection(p, function(g) {
                        ...
                        for (k = 0; k < B; k++)
                            ...
                            F.scope) {
                                ...
                                do
                                    u = u.nextSibling;
                                while (u && u.$$NG_REMOVED);F.clone[0] != u && c.move(rb(F.clone), null , C(t));
            ...
            link: function(a, c, d, e) {
                ...
                if (f) {
                    ...
                    if (d.multiple) {
                        ...
                        var h, l = NaN;
                        a.$watch(function() {
                            l !== f.$viewValue || ka(h, f.$viewValue) || (h = ja(f.$viewValue),
                            f.$render());
                            l = f.$viewValue
                        });
    ...
    ;
    Q.angular.bootstrap ? console.log("WARNING: Tried to load angular more than once.") : (ae(),
    ce(aa),
