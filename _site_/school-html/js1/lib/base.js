...
mainApp.factory("ajax", function ($http) {
    var ajax = {
        ...
        create: function (url, data, success, error) {
            $http.post(url, data, {timeout: 5000}).success(success).error(error)
        },
...
var teachers = {
    "1": {
        ...
        img: "akun.jpg",
        dan:"超凡大师",
        role:"中单，上单，100场游戏，我可能会玩一把下路",
        heros:["Malphite.png","TwistedFate.png", "Yasuo.png"],
        teacherId:1,
        well:100,
        intro:"想学瞎子一秒六脚么？想学锐雯光速QA么？想学猴子1秒8棍么？这些，我，全！不教。想泡妞么？想用最简单的方法上分么？想学“高尚纯洁”的套路么？OK你找对人了，哦对了，作为一个严肃认真的老师我是不会接受妹子的预约的（妹子请直接私聊我QQ，么么哒）",
    ...
    "2": {
        ...
        dan:"超凡大师",
        role:"全能，没有不会的",
        heros:["Ezreal.png","Riven.png", "Zed.png"],
        teacherId:2,
        well:100,
        intro:"认真负责（淫荡无耻）的天才少年（中老年人）\n 从老师的头像就可以看出阿坤是多么的爱护小帅了（肮脏的PY交易）\n负责人的说，不管你想学任何英雄，任何技巧，小帅都可以帮你解决\n100场上大师，30场上钻石，而且还是一个19岁的单身哦！（x粉狂魔）"
    }
}
