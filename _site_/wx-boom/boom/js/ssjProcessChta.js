...
$(function () {
    ...
    function getSsjProcessChta() {
        ...
        $.get(bMock.getFace("ssjProcessChta"), function (data, status) {
            ...
            $.each(data.data,function(i,v){
                ...
                var section1="";
                section1+= '<div class="chat">'+'<section>'+'<div class="revpros_chta_cont revpros_chta_cont'+i+'">'+'<div class="revpros_chta_pic_wrap">'+'<div class="revpros_chta_pic">'+'<div class="revcp_cot">'+'<div class="revcp_cott">'+'<img src="http://static.iboom.tv/static/img/'+data.data[i].head+'">'+'</div>'+'</div>'+'</div>'+'</div>'+'<div class="revpros_chta_cnt_wrap">'+'<div class="revpros_chta_cnt">'+'<dl>'+'<dt>'+'<ul>'+'<li>'+data.data[i].name+'</li>'+'<li>明天可约</li>'+'</ul>'+'</dt>'+'<dd class="revpros_chta_cnt_d1">'+'<ul>'+'<li>授课范围：</li>'+'<li class="revcp_cott_jx'+i+'">'+data.data[i].teachRange+'</li>'+'</ul>'+'</dd>'+'<dd>'+'<ul>'+'<li>累计完成：</li>'+'<li>' + data.data[i].num + '次生死局助教</li>'+'</ul>'+'</dd>'+'<dd>'+'<ul>'+'<li>擅长英雄：</li>'+'<li>'+'<ol class="heroo">'+pp+'</ol>'+'</li>'+'</ul>'+'</dd>'+'<dd>'+'<a href="ssjservice.html?'+data.data[i].userId+'">'+'<button>预约老师</button>'+'</a>'+'</dd>'+'</dl>'+'</div>'+'</div>'+'<div class="clear"></div>'+'</div>'+'</section>'+'</div>'
                sections+=section1;
    ...
    $("select").change(function () {
        $(".chat").remove();
        if($("#ssel").find("option:selected").val()=="中路"){
            function getRevtProcessChta2() {
                $.get(bMock.getFace("ssjProcessChta"), function (data, status) {
                    ...
                    $.each(data.data,function(k,val){
                        console.log(data.data[k].teachRange);
                    ...
                    $.each(arry,function(i,v){
                        ...
                        var section1="";
                        section1+= '<div class="chat">'+'<section>'+'<div class="revpros_chta_cont revpros_chta_cont'+i+'">'+'<div class="revpros_chta_pic_wrap">'+'<div class="revpros_chta_pic">'+'<div class="revcp_cot">'+'<div class="revcp_cott">'+'<img src="http://static.iboom.tv/static/img/'+arry[i].head+'">'+'</div>'+'</div>'+'</div>'+'</div>'+'<div class="revpros_chta_cnt_wrap">'+'<div class="revpros_chta_cnt">'+'<dl>'+'<dt>'+'<ul>'+'<li>'+arry[i].name+'</li>'+'<li>明天可约</li>'+'</ul>'+'</dt>'+'<dd class="revpros_chta_cnt_d1">'+'<ul>'+'<li>授课范围：</li>'+'<li class="revcp_cott_jx'+i+'">'+arry[i].teachRange+'</li>'+'</ul>'+'</dd>'+'<dd>'+'<ul>'+'<li>累计完成：</li>'+'<li>' + arry[i].num + '次生死局助教</li>'+'</ul>'+'</dd>'+'<dd>'+'<ul>'+'<li>擅长英雄：</li>'+'<li>'+'<ol class="heroo">'+pp+'</ol>'+'</li>'+'</ul>'+'</dd>'+'<dd>'+'<a href="ssjservice.html?'+arry[i].userId+'">'+'<button>预约老师</button>'+'</a>'+'</dd>'+'</dl>'+'</div>'+'</div>'+'<div class="clear"></div>'+'</div>'+'</section>'+'</div>'
                        sections+=section1;
            ...
            function getRevtProcessChta2() {
                $.get(bMock.getFace("ssjProcessChta"), function (data, status) {
                    ...
                    $.each(arry,function(i,v){
                        ...
                        var section1="";
                        section1+= '<div class="chat">'+'<section>'+'<div class="revpros_chta_cont revpros_chta_cont'+i+'">'+'<div class="revpros_chta_pic_wrap">'+'<div class="revpros_chta_pic">'+'<div class="revcp_cot">'+'<div class="revcp_cott">'+'<img src="http://static.iboom.tv/static/img/'+arry[i].head+'">'+'</div>'+'</div>'+'</div>'+'</div>'+'<div class="revpros_chta_cnt_wrap">'+'<div class="revpros_chta_cnt">'+'<dl>'+'<dt>'+'<ul>'+'<li>'+arry[i].name+'</li>'+'<li>明天可约</li>'+'</ul>'+'</dt>'+'<dd class="revpros_chta_cnt_d1">'+'<ul>'+'<li>授课范围：</li>'+'<li class="revcp_cott_jx'+i+'">'+data.data[i].teachRange+'</li>'+'</ul>'+'</dd>'+'<dd>'+'<ul>'+'<li>累计完成：</li>'+'<li>' + arry[i].num + '次生死局助教</li>'+'</ul>'+'</dd>'+'<dd>'+'<ul>'+'<li>擅长英雄：</li>'+'<li>'+'<ol class="heroo">'+pp+'</ol>'+'</li>'+'</ul>'+'</dd>'+'<dd>'+'<a href="ssjservice.html?'+arry[i].userId+'">'+'<button>预约老师</button>'+'</a>'+'</dd>'+'</dl>'+'</div>'+'</div>'+'<div class="clear"></div>'+'</div>'+'</section>'+'</div>'
                        sections+=section1;
