...
// helpers
    ...
    function observe(value) {
        ...
        if (hasOwn(value, '__ob__') && value.__ob__ instanceof Observer) {
            ...
            observerState.shouldConvert && !config._isServer &&
    ...
    function createPatchFunction(backend) {
        ...
        function createElm(vnode, insertedVnodeQueue, nested) {
            ...
            if (isDef(tag)) {
                {
                    if (
                        !vnode.ns && !(config.ignoredElements && config.ignoredElements.indexOf(tag) > -1) &&
    ...
    var model = {
        inserted: function inserted(el, binding, vnode) {
            ...
            if (vnode.tag === 'select') {
                ...
                (vnode.tag === 'textarea' || el.type === 'text') && !binding.modifiers.lazy
            ) {
                if (!isAndroid) {
...
// wrap mount
    Vue$2.prototype.$mount = function (el,
                                       hydrating) {
